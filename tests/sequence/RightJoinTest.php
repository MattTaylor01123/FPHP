...
class RightJoinTest extends TestCase
{
    public function testArray()
    {
        ...
        $out2 = F::rightJoin(fn($v1, $v2) => $v1->userId === $v2->userId, fn(...$args) => F::mergeAllLeft(...$args), $seq1, $seq2);
        $this->assertEquals([
    ...
    public function testTraversable()
    {
        ...
        $out1 = F::rightJoin(fn($v1, $v2) => $v1->userId === $v2->userId, fn(...$args) => F::mergeAllLeft(...$args), $seq1, $seq2);
    ...
    public function testLaziness()
    {
        ...
        $out1 = F::rightJoin($fnPred, fn(...$args) => F::mergeAllLeft(...$args), $seq1, $seq2);
        ...
        $this->assertTrue($iter->valid());
        $v2 = $iter->current();
        $this->assertEquals(6, $called);    // not 8 because iterate right first
        ...
        $this->assertEquals((object)["accountId" => 13, "userId" => 5, "email" => "elliot.clark@gmail.com"], $v3);
